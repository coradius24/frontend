...
const SamplePage = () => {
  ...
  const { isPending, error, data } = useQuery({
    queryKey: ["adminStudentEarning", query],
    queryFn: () => earningService.getAdminEarning(getQueryString(query)),
  });
  ...
  return (
    <PageContainer title="Student Earning" description="this is Sample page">
      <Breadcrumb title="Student Earning" items={BCrumb} />
