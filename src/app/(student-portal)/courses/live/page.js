...
export const metadata = {
  title: "Live Courses | UpSpot Academy",
  description: `Upspot Academy Live courses`,
...
const Page = async ({ searchParams }) => {
  ...
  if (queryString === "") {
    queryString =
      "limit=9&page=1&price=all&level=beginner&rating=all&category=all&sort_by=newest&contentType=live";
  }
    ...
    <>
      <HeroBanner className="main-courses">
        <div className="content center">
          <h1>আপনার পছন্দের লাইভ কোর্সটি সিলেক্ট করুন </h1>
          <p>
            আপনার পছন্দের লাইভ কোর্সটি বেছে নিন এবং নিজের স্কিলকে একধাপ এগিয়ে
            নিয়ে যান।
          </p>
        </div>
      </HeroBanner>
